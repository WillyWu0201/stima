...
enum PreviewData {
    ...
    static func makeSampleQuotes() -> [Quote] {
        let data: [(client: String, location: String, dateStr: String, status: QuoteStatus, folder: String?, items: [(String, String, Double, Int)])] = [
            ("王先生", "台北市信義區", "2026-05-15", .ongoing, "2026",  [("拆除磁磚", "坪", 10, 1800), ("冷氣排水管", "式", 1, 3500), ("油漆批土", "坪", 25, 850)]),
            ("林太太", "新北市板橋區", "2026-05-10", .paid,    "2026",  [("水電配管", "式", 1, 35000), ("新增插座", "個", 8, 1200)]),
            ("張先生", "台北市大安區", "2026-04-28", .ongoing, "老客戶", [("木作天花板", "坪", 30, 3200), ("系統櫃", "尺", 25, 4500)]),
            ("李小姐", "新北市中和區", "2026-04-15", .done,    "2026",  [("貼磁磚", "坪", 8, 2800), ("防水工程", "坪", 8, 1800)]),
            ("黃先生", "桃園市中壢區", "2026-03-20", .draft,   nil,     [("冷氣排水管", "式", 2, 3500), ("全室油漆", "坪", 35, 1200)]),
            ("陳老闆", "台北市內湖區", "2026-02-12", .paid,    "老客戶", [("木作天花板", "坪", 25, 3200), ("系統櫃", "尺", 18, 4500), ("全室油漆", "坪", 18, 1200)]),
        ]
